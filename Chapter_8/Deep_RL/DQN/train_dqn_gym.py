...
def main():
    ...
    parser.add_argument('--outdir', type=str, default='dqn_training', help='Directory path to save output files. If it does not exist, it will be created.')
    parser.add_argument('--env', type=str, default='TTT-DQN-v0')
    ...
    # Initialize the NN used to estimatethe q-function
    ...
    # Optional: Draw the computational graph and save it in the output directory.
